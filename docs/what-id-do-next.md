...
- Add a full WordPress activation pipeline with generated fixture files copied into `wp-env`.
...
- Add visual regression tests for the structural preview and downloaded file tree.
