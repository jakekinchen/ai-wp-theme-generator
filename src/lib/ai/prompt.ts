...
export function buildThemePlanPrompt(input: NormalizedThemeInput, repair?: string): string {
  return [
    ...
    "- Fill design.intent with audience, personality, hierarchy, density, image treatment, rhythm, nav style, surface, and a concrete signature move.",
    ...
    "Design taste guidance: prefer specific first-viewport hierarchy, a clear content rhythm, and one memorable signature move over generic sections.",
